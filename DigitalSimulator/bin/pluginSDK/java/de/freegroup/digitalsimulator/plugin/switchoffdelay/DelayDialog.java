package de.freegroup.digitalsimulator.plugin.switchoffdelay;
...
public class DelayDialog extends GenericDialog 
{
    ...
    {
      super(I18N.get("COMMON.DIALOGHEADER.OBJECTSWITCHOFFDELAYDIALOG"),
        I18N.get("OBJECTSWITCHOFFDELAYDIALOG.LABEL.HELPHEADER"),
        I18N.get("OBJECTSWITCHOFFDELAYDIALOG.LABEL.HELPLINE01"),
        I18N.get("OBJECTSWITCHOFFDELAYDIALOG.LABEL.HELPLINE02"));
    ...
    public Component buildInputPanel()
    {
      ...
      builder.addLabel(I18N.get("OBJECTSWITCHOFFDELAYDIALOG.LABEL.DELAY") , cc.xy  (2, 2));
