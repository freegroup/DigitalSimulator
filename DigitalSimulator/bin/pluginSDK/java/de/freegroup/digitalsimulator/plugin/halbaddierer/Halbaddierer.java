package de.freegroup.digitalsimulator.plugin.halbaddierer;

/**
 * Title:
 * Description:  1-Bit Halbaddierer
...
public class Halbaddierer extends ObjectPlugin implements ILiveUpdateObject
{
  ...
  public boolean doConfigure(byte[] param) { return false; }
   ...
   {
      return "1-Bit Halbaddierer. A und B werden addiert. Der Ausgang S gibt die Summe an."+
   ...
   public void paint(int xPos, int yPos, byte[] param)
   {
      ...
      Painter.drawText( "HA",50, xPos+(int)(BREITE/2-25), yPos-(HOEHE/2-30));
      Painter.drawText( "A",35, xPos+7        , yPos-((HOEHE/3)  -35));
      Painter.drawText( "B",35, xPos+7        , yPos-((HOEHE/3*2)   ));
