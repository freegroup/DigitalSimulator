...
public class InputBus extends ObjectPlugin implements ILiveUpdateObject
{
    final static int INPUT_COUNT  = 8;
    final static int OUTPUT_COUNT = 0;
    ...
    static
    {
      try
      {
        ...
        //
        Class.forName(BusDialog.class.getName());
      }
   ...
   {
      return "8-bit Bus (input)";
   }

   // ....
   public String  getName()
   {
      return "OBJECT.INPUTBUS.8.BIT";
   }
   ...
   {
      BusManager.setData(new Integer(param[0]),input);
      return false;
   }
