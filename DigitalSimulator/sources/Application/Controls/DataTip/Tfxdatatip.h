...
// class operations
public:
    static void SetShowDelay(short delay);
    static void SetHideDelay(short delay);
...
protected:
    ...
    static short _showDelay;
    static short _hideDelay;
    static short _count;
...
inline void TFXDataTip::SetShowDelay(short delay)
    { _showDelay = delay; }
inline void TFXDataTip::SetHideDelay(short delay)
    { _hideDelay = delay; }
