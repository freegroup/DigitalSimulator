...
class _dbCasePin extends dbObject 
{
	...
	{
		return _dbObjectPin2CasePin.findByCasePin(this);
	}
	...
	public static ArrayList findByDescription(String _description)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE description='"+toSQL(_description)+"'");
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
					newObject.y=s.getLong(2);
					newObject.caseLayout_id=s.getString(3);
					newObject.x=s.getLong(4);
					newObject.id=s.getString(5);
					newObject.number=s.getLong(6);
	...
	public static ArrayList findByY(long _y)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE y="+_y);
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
	...
	public static ArrayList findByCaseLayout(_dbCaseLayout _caseLayout)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE caseLayout_id='"+toSQL(((_caseLayout==null)?"":_caseLayout.getId()))+"'");
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
	...
	public static ArrayList findByX(long _x)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE x="+_x);
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
	...
	public static CasePin findById(String _id)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE id='"+toSQL(_id)+"'");
				if(s.next())
				{
					result = new CasePin();
					result.description= s.getString(1);
					result.y= s.getLong(2);
					result.caseLayout_id= s.getString(3);
					result.x= s.getLong(4);
					result.id= s.getString(5);
					result.number= s.getLong(6);
				}
			}
			catch(Exception exc)
			{
	...
	public static ArrayList findByNumber(long _number)
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin WHERE number="+_number);
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
	...
	public boolean commit()
	{
		...
		try
		{
			...
			try
			{
				stmt.executeUpdate( "UPDATE CasePin set description= '"+toSQL(description)+"', y= "+y+", caseLayout_id= '"+toSQL(caseLayout_id)+"', x= "+x+", number= "+number+" WHERE id='"+id+"'");
			}
			catch(Exception exc)
			{
				Trace.error(exc);
	...
	public static ArrayList getAll()
	{
		...
		try
		{
			...
			try
			{
				ResultSet s = stmt.executeQuery( "SELECT description, y, caseLayout_id, x, id, number FROM CasePin");
				while(s.next())
				{
					CasePin newObject = new CasePin();
					newObject.description=s.getString(1);
	 ...
	 */
	static public CasePin createInstance( String  _description, long  _y, _dbCaseLayout _caseLayout, long  _x, long  _number )
	{
		CasePin result = null;
		SaveStatement  stmt;
		...
		try
		{
			...
			try
			{
				...
				stmt.executeUpdate( "INSERT INTO CasePin ( description, y, caseLayout_id, x, id, number) VALUES ( '"+toSQL(_description)+"', "+_y+",  '"+((_caseLayout==null)?"":_caseLayout.getId())+"', "+_x+", '"+nextGUID+"', "+_number+")");
				result = new CasePin();
	 ...
	 * create a new object in the database
	 */
	static public void newInstance( String  _description, long  _y, _dbCaseLayout _caseLayout, long  _x, long  _number )
	{
		SaveStatement  stmt;
