...
public class ElectricObject extends _dbElectricObject
{
    ...
    static public ElectricObject createInstance(boolean  isSingelton, String  type, _dbObjectLayout layout)
    {
      return _dbElectricObject.createInstance( 20, isSingelton?1:0, 20,   type,10, 10, layout );
    }
   ...
   public ObjectPin2CasePin getPin(long number)
    ...
    public CasePin getCasePin(long objectPinIndex)
    {
        ...
        else
        {
           ...
           {
               ObjectPin2CasePin opin= (ObjectPin2CasePin)iter.next();
               if(opin.getObjectPin().getNumber()==objectPinIndex)
           ...
           for(Iterator iter = connections.iterator(); iter.hasNext();)
            {
               ...
               long fromNum = con.getFromPinNum();
