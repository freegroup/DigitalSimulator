...
public class SwitchOffDelay extends ObjectPlugin implements ILiveUpdateObject
{
    ...
    {
      return "Switch off delay";
    }

   // ....
   public String  getName()
   {
      return "OBJECT.SWITCHOFFDELAY";
   }
   ...
   public void paint(int xPos, int yPos, byte[] param)
   {
      ...
      //
      Painter.drawText("t - 0",40,xPos+25,yPos-50);
